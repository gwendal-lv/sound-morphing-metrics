...
Authors:
2019 Andy Pearce, Institute of Sound Recording, University of Surrey, UK
...
def timbral_depth(audio_data,
                  dev_output=False, clip_output=False, threshold_db=-60,
                  centroid_crossover_frequency=2000, ratio_crossover_frequency=500,
    ...
    audio_samples = audio_data['hp20Hz_audio_samples']
